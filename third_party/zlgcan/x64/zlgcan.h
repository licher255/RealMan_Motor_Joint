...
#define DEF_DOIP_UDS_DATA                   3 // DOIP UDS����(�ݲ�֧��)    
...
//��̬���� �־����� BEGIN
#define	ZCAN_DYNAMIC_CONFIG_DEVNAME "DYNAMIC_CONFIG_DEVNAME"// �豸�����Ϊ32�ֽڣ�������\0������CANFDNET - 200UĬ��ֵΪ��CANFDNET - 200U����CANFDNET - 100MINIĬ��ֵΪ��CANFDNET - 100MINI��
//CAN��ͨ��������Ϣ(CAN%d����и�ʽ������ͨ�� ��Χ��0-7)
#define	ZCAN_DYNAMIC_CONFIG_CAN_ENABLE "DYNAMIC_CONFIG_CAN%d_ENABLE"// ͨ��ʹ�ܣ�1��ʹ�ܣ�0��ʧ�ܣ�CANFDNETϵ�в�Ʒͨ��Ĭ��ʹ�ܡ�
#define	ZCAN_DYNAMIC_CONFIG_CAN_MODE "DYNAMIC_CONFIG_CAN%d_MODE"// ����ģʽ��Ĭ������ģʽ��0������ģʽ��1��ֻ��ģʽ��
#define	ZCAN_DYNAMIC_CONFIG_CAN_TXATTEMPTS "DYNAMIC_CONFIG_CAN%d_TXATTEMPTS"// ����ʧ���Ƿ��ش���0������ʧ�ܲ��ش�1������ʧ���ش���ֱ�����߹رգ�CANFDNET - 100 / 200�޴������ã�
...
#define	ZCAN_DYNAMIC_CONFIG_CAN_BUSRATIO_ENABLE "DYNAMIC_CONFIG_CAN%d_BUSRATIO_ENABLE"// ����������ʹ�ܣ�ʹ�ܺ󣬽����ڷ������������ʵ��趨��TCP/UDP���ӡ�1:ʹ�ܣ�0��ʧ��
#define	ZCAN_DYNAMIC_CONFIG_CAN_BUSRATIO_PERIOD "DYNAMIC_CONFIG_CAN%d_BUSRATIO_PERIOD"// ���������ʲɼ����ڣ�ȡֵ200~2000ms
...
struct CANFD_FILTER_RULE
{
	...
	int                         nErr;       // �Ƿ�����ģ�������һ�����ڣ���ʾ��������������֡���Ǵ���֡,0:�����˴���֡ 1:���˴���֡
	int                         nChnl;      // ͨ��
	...
	int                         nFilterDataLen;
	int                         nMaskDataLen;
	BYTE                        nFilterData[CANFD_DATA_LEN_MAX]; // ���Ĺ�������,uint8���飬�64
	BYTE                        nMaskData[CANFD_DATA_LEN_MAX];   // ������������,uint8���飬�64����������ݳɶԴ���
};
...
typedef struct tagZCAN_DYNAMIC_CONFIG
{
	...
	UINT                  isPersist;         // �Ƿ��ǳ־����ã����豸���籣�����ã���TRUE-�־����� FALSE-��̬����
	union
	{
		CANFD_FILTER_CFG filterCfg;          // dynamicConfigDataType = DYNAMIC_CONFIG_FILTERʱ��Ч
...
typedef struct tagZCAN_CHANNEL_INIT_CONFIG {
    UINT can_type;                          //type:TYPE_CAN TYPE_CANFD��can_type���豸����ֻȡ���ڲ�ƷӲ�������ͣ�CANFDϵ�еĲ�Ʒ��������Ϊ1����ʾCANFD�豸��
    union
    {
        struct
        {
 ...
 * @param[in] dataBufSize ��Ӧ���ݻ������ܴ�С�����С����Ӧ������ݳ��ȣ����� STATUS_BUFFER_TOO_SMALL
 * @return ִ�н��״̬
 */
